...
uniform vec4 LightColor;  //componente ambiental
uniform vec4 LightPower; // vector L en Phong. Intensidad de fuente de Iluminacion. Esta en watts
uniform int  alphaIndex; //opacidad
uniform float distance;  //vector r
...
//    FragColor = texel * ex_color;
    FragColor = ex_color;  //quitamos la textura
}